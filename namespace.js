...
const descriptions = {
    ...
    RU: {
        ...
        'Требование: Уровень 2',
        ComebackKid: ' позволяет один раз за бой вернуться к жизни с 20% здоровья, ' +
        'когда враг наносит смертельный удар. Если вы умрете в бою, ' +
